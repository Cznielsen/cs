...
void Publisher::handleMsgIdTimeOut()
{
  ...
  HelloMsg* msg = new HelloMsg();  // Create message object
  msg->data_ = "here come dat boi!"; // Insert data
  MessageDistributionSystem::getInstance().notify(HELLO_MSG, msg); // Notify subs and send msg
