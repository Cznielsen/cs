 ...
 */
public class CountPrimes4 implements Runnable {
    private int threadNo;
    static Counter counter = new Counter(4);
    static int threads = 4;

    public CountPrimes4(int threadNo) {
    ...
    public static void main(String[] args) throws InterruptedException {
        CountPrimes4 cp1 = new CountPrimes4(1);
        CountPrimes4 cp2 = new CountPrimes4(2);
        CountPrimes4 cp3 = new CountPrimes4(3);
        CountPrimes4 cp4 = new CountPrimes4(4);
