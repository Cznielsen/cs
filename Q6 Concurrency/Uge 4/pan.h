...
#define PanSource	"minpeterson.pml"
...
#define nstates2	813	/* ltl_0 */
#define minseq2	42
#define maxseq2	853
#define endstate2	812

#define nstates1	22	/* p1 */
#define minseq1	21
#define maxseq1	41
#define endstate1	21

#define nstates0	22	/* p0 */
#define minseq0	0
#define maxseq0	20
#define endstate0	21
...
#else
	#define ACCEPT_LAB	13 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
